...
menu = st.sidebar.selectbox("Selecciona una página", ("Inicio", "Estadísticas CSV", "Estadísticas API"))
...
# ====================== ESTADÍSTICAS CSV ======================
    ...
    if st.button("Exportar a PDF"):
        ...
        for _, row in df_filtrado[columnas_mostrar].iterrows():
            ...
            pdf.cell(200, 10, txt=fila[:200], ln=True)  # Limita longitud de línea
...
# ====================== ESTADÍSTICAS API ======================
    ...
    if teams:
        ...
        if team_info:
    		if 'strTeamBadge' in team_info and team_info['strTeamBadge']:
       			st.image(team_info['strTeamBadge'], width=100)
    	else:
       		st.write("No se encontró el logo del equipo")
